...
/////////////////
const BotName = 'AMD BOT☄'; 
const instagram = 'https://instagram.com/_ahhmad_.f'; 
const telegram = '-'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UC0ECqULbTSD0Wiz8mz0wTVw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@_ahhmad_.f')
